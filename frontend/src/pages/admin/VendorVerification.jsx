  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto pb-12">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <Link to="/admin/business-approvals" className="text-sm text-white/60 hover:text-white flex items-center gap-1 w-fit mb-2 transition-colors">
            <ArrowLeft className="w-4 h-4" /> Back to Queue
          </Link>
          <h1 className="text-2xl font-bold text-white flex items-center gap-2">
            Verification: APP-1042
          </h1>
          <p className="text-white/60">Review submitted documents for Apex Catering LLC.</p>
        </div>
        <div className="flex gap-2">
          <Button variant="outline" className="text-red-400 border-red-400/20 hover:bg-red-400/10" leftIcon={<X className="w-4 h-4"/>}>
            Reject Application
          </Button>
          <Button className="bg-green-500 hover:bg-green-600 text-white border-none" leftIcon={<Check className="w-4 h-4"/>}>
            Approve Business
          </Button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 pt-6">
        ...
        <div className="space-y-6">
          <Card className="border-green-500/20 bg-green-500/5">
            ...
            <CardContent>
              <div className="text-4xl font-bold text-white mb-2">Low Risk</div>
              <p className="text-sm text-white/70">The submitted identity documents match public records. No red flags detected.</p>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-white/50">Owner / CEO</p>
                </div>
              </div>

              <div className="pt-4 border-t border-white/5 space-y-3">
                <div>
                  <span className="text-xs text-white/40 uppercase font-bold block mb-1">Email Address</span>
                  <span className="text-sm text-white">james@apexcatering.com</span>
                  <span className="ml-2 text-[10px] bg-green-500/20 text-green-400 px-2 py-0.5 rounded font-bold">Verified</span>
                </div>
                <div>
                  <span className="text-xs text-white/40 uppercase font-bold block mb-1">Phone Number</span>
        ...
        <div className="lg:col-span-2 space-y-6">
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="p-4 rounded-xl border border-white/10 bg-surface/30 flex justify-between items-center group">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-lg bg-primary/10 flex items-center justify-center shrink-0 text-primary">
                    <UserCheck className="w-6 h-6" />
                  </div>
                  <div>
                    <h4 className="font-bold text-white">Government ID (Passport)</h4>
                    <p className="text-xs text-white/50">Submitted Oct 24, 2026</p>
                  </div>
                </div>
              ...
              <div className="p-4 rounded-xl border border-white/10 bg-surface/30 flex justify-between items-center group">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-white">Business License (LLC)</h4>
                    <p className="text-xs text-white/50">Issued by State of California</p>
                  </div>
                </div>
                <Button variant="outline" size="sm" leftIcon={<Eye className="w-4 h-4"/>}>Inspect</Button>
              </div>
              ...
              <div className="p-4 rounded-xl border border-yellow-500/20 bg-yellow-500/5 flex justify-between items-center group">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-white">Certificate of Insurance (COI)</h4>
                    <p className="text-xs text-white/50">Requires manual review for liability coverage limits.</p>
                  </div>
                </div>
                <Button variant="outline" size="sm" leftIcon={<Eye className="w-4 h-4"/>}>Inspect</Button>
              </div>
