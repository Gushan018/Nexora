    ...
    <div className="space-y-6 max-w-7xl mx-auto pb-12">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-slate-600">View, modify, and enforce policies across all platform accounts.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <Card className="border-slate-300">
          <CardContent className="p-6">
            ...
            <div className="flex items-end gap-3">
              <span className="text-3xl font-bold text-slate-900">47,152</span>
            </div>
          </CardContent>
        </Card>
        <Card className="border-slate-300">
          <CardContent className="p-6">
            ...
            <div className="flex items-end gap-3">
              <span className="text-3xl font-bold text-slate-900">45,300</span>
            </div>
          </CardContent>
        </Card>
        <Card className="border-slate-300">
          <CardContent className="p-6">
            <h3 className="text-sm font-medium text-slate-600 mb-2">Vendors</h3>
            <div className="flex items-end gap-3">
        ...
        <Card className="border-red-500/20 bg-red-500/5">
          <CardContent className="p-6">
            <h3 className="text-sm font-medium text-slate-800 mb-2">Suspended</h3>
            <div className="flex items-end gap-3">
      ...
      <Card>
            ...
            <tbody className="text-sm">
              {USERS.map((user, i) => (
                <tr key={i} className="border-b border-slate-200 hover:bg-slate-50 transition-colors group">
                  <td className="p-4 pl-6">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="text-xs text-slate-500">{user.email} • {user.id}</span>
                      </div>
                    </div>
                  </td>
                  <td className="p-4">
                  ...
                  <td className="p-4 text-slate-800">{user.joined}</td>
        ...
        <div className="p-4 border-t border-slate-200 flex justify-center">
          <Button variant="ghost" className="text-slate-600 hover:text-slate-900">Load More Users</Button>
        </div>
      </Card>
    </div>
  );
