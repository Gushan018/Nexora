    ...
    <div className="space-y-6 max-w-7xl mx-auto pb-12 flex flex-col lg:flex-row gap-6 lg:gap-8">
      ...
      <div className="flex-1 space-y-6">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600 dark:text-white/60 mt-1">Manage global platform configurations and branding.</p>
        </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-1.5 pt-2">
              <label className="text-sm font-medium text-gray-700 dark:text-white/80 block">Platform Logo (Dark Mode)</label>
              <div className="flex items-center gap-4">
                <div className="w-16 h-16 rounded bg-light-surface dark:bg-surface border border-gray-300 dark:border-white/10 flex items-center justify-center">
                  <span className="font-bold text-gray-900 dark:text-white tracking-widest text-xs">NEXORA</span>
                </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="flex items-center justify-between p-4 rounded-xl border border-gray-200 dark:border-white/10 bg-light-surface dark:bg-surface/50">
              <div>
                <h4 className="font-bold text-gray-900 dark:text-white text-sm">Maintenance Mode</h4>
                <p className="text-xs text-gray-600 dark:text-white/50 mt-1 max-w-md">When enabled, the public marketplace is disabled and shows a "Down for Maintenance" page. Admins can still log in.</p>
              </div>
