...
export const AdminDashboard = () => {
  ...
  const recentActivities = data?.recentActivities?.length
    ...
    : [
        { id: 'BKG-901', type: 'Booking', text: 'New booking from Sarah Customer â€” Premium Buffet', time: '2 hours ago' },
        { id: 'VND-802', type: 'Vendor', text: 'Vendor "Bloom Designs" registered', time: '5 hours ago' },
        { id: 'BKG-899', type: 'Booking', text: 'Booking completed â€” Live DJ Set', time: '1 day ago' },
      ];
  return (
                  ...
                  <div className="flex items-center justify-between gap-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500 dark:text-white/50">{activity.type} â€¢ {activity.time}</p>
                      </div>
                    </div>
...
// Simple lightweight SVG area chart (no external deps) â€” responsive
