  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-12">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        {/* Main Chart */}
        <Card className="xl:col-span-2 border-slate-200 h-[450px] flex flex-col">
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <select className="bg-surface border border-slate-300 rounded-lg px-3 py-1.5 text-sm text-slate-900 focus:outline-none focus:border-primary/50 cursor-pointer">
          ...
          <CardContent className="flex-1 flex items-center justify-center border-t border-slate-200 relative">
            ...
            <div className="text-center z-10">
              ...
              <p className="text-slate-500 font-medium">Recharts Area Chart</p>
              <p className="text-xs text-slate-400">Visualizing monthly platform fees vs total GMV</p>
            </div>
          </CardContent>
        </Card>
            ...
            <CardContent className="space-y-4">
              <div className="p-3 rounded-lg bg-yellow-500/10 border border-yellow-500/20 flex gap-3 items-start">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-600 mt-0.5">API latency is currently 250ms above average threshold.</p>
                </div>
              </div>
              <div className="p-3 rounded-lg bg-red-500/10 border border-red-500/20 flex gap-3 items-start">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-600 mt-0.5">3 vendor Stripe payouts failed in the last hour.</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-0">
              <div className="divide-y divide-white/5">
                <div className="p-4 flex items-center justify-between hover:bg-slate-50 cursor-pointer transition-colors">
                  <div>
                    <h4 className="text-sm font-medium text-slate-900">Vendor Approvals</h4>
                    <p className="text-xs text-slate-500">Requires identity verification</p>
                  </div>
                  <span className="px-2 py-1 bg-primary/20 text-primary font-bold text-xs rounded-full">42</span>
                </div>
                <div className="p-4 flex items-center justify-between hover:bg-slate-50 cursor-pointer transition-colors">
                  <div>
                    <h4 className="text-sm font-medium text-slate-900">Disputes</h4>
                    <p className="text-xs text-slate-500">Active customer/vendor conflicts</p>
                  </div>
                  <span className="px-2 py-1 bg-red-500/20 text-red-400 font-bold text-xs rounded-full">12</span>
                </div>
                <div className="p-4 flex items-center justify-between hover:bg-slate-50 cursor-pointer transition-colors">
                  <div>
                    <h4 className="text-sm font-medium text-slate-900">Reported Reviews</h4>
                    <p className="text-xs text-slate-500">Flagged by community</p>
                  </div>
...
const StatCard = ({ title, value, trend, trendUp, icon, color }) => (
  <Card className="border-slate-200 overflow-hidden relative group">
    ...
    <CardContent className="p-6 relative z-10">
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="w-10 h-10 rounded-xl bg-surface/80 flex items-center justify-center border border-slate-300 backdrop-blur-md">
          {icon}
        </div>
      </div>
