    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-slate-600">Find exactly what you need with our advanced filters.</p>
        </div>
      </div>
          ...
          <Card>
            <CardContent className="p-5 space-y-6">
              <div className="space-y-2">
                <h3 className="text-sm font-bold text-slate-900">Service Category</h3>
                <div className="space-y-2 text-sm text-slate-600">
                  {['Venues', 'Photography', 'Catering', 'Entertainment', 'Decor'].map(cat => (
                    <label key={cat} className="flex items-center gap-2 cursor-pointer hover:text-slate-900 transition-colors">
              ...
              <div className="space-y-2 border-t border-slate-200 pt-4">
                ...
                <div className="relative">
                  ...
                  <input type="text" placeholder="City or zip code" className="w-full bg-surface border border-slate-300 rounded-lg pl-9 pr-3 py-2 text-sm text-slate-900 focus:outline-none focus:border-primary transition-colors" />
                </div>
              </div>

              <div className="space-y-2 border-t border-slate-200 pt-4">
                <h3 className="text-sm font-bold text-slate-900">Minimum Rating</h3>
                <div className="flex gap-2">
                  {[4, 4.5, 5].map(rating => (
                    <button key={rating} className="flex items-center gap-1 px-2 py-1 bg-surface border border-slate-300 rounded-lg text-sm text-slate-900 hover:border-primary transition-colors">
        ...
        <div className="lg:col-span-3 space-y-6">
          <div className="relative">
            ...
            <input 
              ...
              className="w-full bg-surface/50 border border-slate-300 rounded-xl pl-14 pr-4 py-4 text-lg text-slate-900 focus:outline-none focus:border-primary transition-colors" 
            />
          ...
          <div className="flex justify-between items-center text-sm text-slate-600">
            ...
            <div className="flex items-center gap-2">
              Sort by: 
              <select className="bg-transparent text-slate-900 border-none outline-none font-medium cursor-pointer">
            ...
            {[1, 2, 3, 4].map(item => (
              <Card key={item} className="overflow-hidden hover:border-primary/50 transition-colors group cursor-pointer flex flex-col">
                <div className="h-48 bg-surface relative">
                  <div className="absolute top-4 left-4 px-2.5 py-1 bg-black/60 backdrop-blur-md rounded-full text-xs font-bold text-slate-900 flex items-center gap-1">
                    <Sparkles className="w-3 h-3 text-yellow-400"/> Featured
                  </div>
                  <div className="absolute top-4 right-4 px-2.5 py-1 bg-slate-200 backdrop-blur-md rounded-full border border-slate-400 text-xs font-bold text-slate-900 flex items-center gap-1">
                    <Star className="w-3 h-3 text-yellow-400 fill-yellow-400"/> 4.9
                  </div>
                </div>
                <CardContent className="p-5 flex-1 flex flex-col justify-between">
                  <div>
                    <h3 className="font-bold text-lg text-slate-900 mb-1 group-hover:text-primary transition-colors">Grand Azure Resort</h3>
