  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative pt-40 pb-12">
      ...
      >
        ...
        <div className="bg-white dark:bg-[#1C2333] border border-slate-200 dark:border-white/10 rounded-3xl p-8 backdrop-blur-2xl shadow-xl relative overflow-hidden group">
        ...
        >
          Don't have an account? <Link to="/register" className="text-primary hover:text-primary-hover font-bold transition-colors underline underline-offset-4">Sign up</Link>
        </motion.p>
