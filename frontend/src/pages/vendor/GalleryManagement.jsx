  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 pt-4">
        ...
        {/* Upload Card */}
        <div className="h-[280px] rounded-2xl border-2 border-dashed border-white/10 flex flex-col items-center justify-center hover:border-primary/50 hover:bg-surface/50 cursor-pointer transition-all group bg-surface/30">
        ...
        {/* Existing Albums */}
        {ALBUMS.map((album) => (
          <div key={album.id} className="h-[280px] rounded-2xl border border-white/5 bg-surface/50 overflow-hidden group relative flex flex-col">
            <div className="h-40 w-full relative overflow-hidden shrink-0">
              ...
              <div className="absolute top-2 right-2 flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                <button className="p-1.5 bg-black/50 backdrop-blur-md rounded text-white hover:text-primary transition-colors">
                  <Edit2 className="w-4 h-4" />
                </button>
                <button className="p-1.5 bg-black/50 backdrop-blur-md rounded text-white hover:text-red-400 transition-colors">
