    ...
    <div className="space-y-6 max-w-5xl mx-auto pb-12">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-white/60">Configure your operational preferences and account security.</p>
        </div>
        ...
        <div className="md:col-span-3 space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  <label className="text-sm font-medium text-white/90">Timezone</label>
                  <select className="w-full bg-surface/50 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-primary/50 transition-colors cursor-pointer">
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-white/90">Booking Lead Time</label>
                <select className="w-full bg-surface/50 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-primary/50 transition-colors cursor-pointer">
                ...
                <p className="text-xs text-white/40">Prevents last-minute bookings from customers.</p>
              </div>
              ...
              <div className="pt-4 border-t border-white/5 space-y-4">
                <label className="flex items-center justify-between p-4 rounded-xl border border-white/10 bg-surface/30 cursor-pointer">
                  <div>
                    <h4 className="text-white font-medium text-sm">Instant Book</h4>
                    <p className="text-xs text-white/50">Automatically approve bookings if your calendar is free.</p>
                  </div>
                ...
                <label className="flex items-center justify-between p-4 rounded-xl border border-white/10 bg-surface/30 cursor-pointer">
                  <div>
                    <h4 className="text-white font-medium text-sm">Require Deposits</h4>
                    <p className="text-xs text-white/50">Force customers to pay 20% upfront to confirm a date.</p>
                  </div>
                ...
                {[
                  ...
                  >
                    <div className="flex justify-between items-start mb-2">
                      <h4 className={cn("font-bold text-sm", policy.selected ? "text-primary" : "text-white")}>{policy.title}</h4>
                      {policy.selected && <div className="w-3 h-3 rounded-full bg-primary" />}
                    </div>
                    <p className="text-xs text-white/60 leading-relaxed">{policy.desc}</p>
                  </div>
                ))}
              </div>
          ...
          <Card className="border-red-500/20">
            ...
            <CardContent className="space-y-4 text-sm">
              <p className="text-white/60">If you want to temporarily hide your business or permanently delete your account, you can do so here.</p>
