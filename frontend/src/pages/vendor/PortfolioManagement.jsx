    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent>
          ...
          {/* Upload Dropzone */}
          <div className="mt-6 border-2 border-dashed border-white/10 hover:border-primary/50 transition-colors rounded-xl p-8 flex flex-col items-center justify-center text-center bg-surface/30 cursor-pointer">
