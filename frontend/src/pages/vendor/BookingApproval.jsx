    ...
    return (
      <div className="pt-24 pb-20 min-h-[calc(100vh-8rem)] flex flex-col items-center justify-center">
        ...
        >
          ...
          <h1 className="text-3xl font-bold text-white mb-4">Request Approved!</h1>
  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto pb-12">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <Link to="/vendor/incoming-requests" className="text-sm text-white/60 hover:text-white flex items-center gap-1 w-fit mb-2 transition-colors">
            <ArrowLeft className="w-4 h-4" /> Back to Inbox
          </Link>
          <h1 className="text-2xl font-bold text-white">Approve Booking</h1>
          <p className="text-white/60">Review details and finalize the quote before accepting.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 pt-6">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex justify-between items-start border-b border-white/5 pb-6">
                <div>
                  ...
                  <p className="text-sm text-white/50">Request ID: REQ-9921</p>
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex items-start gap-3 bg-surface/50 p-4 rounded-xl border border-white/5">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-white font-medium">Saturday, Oct 14, 2026</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 bg-surface/50 p-4 rounded-xl border border-white/5">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-white font-medium">Grand Azure Resort, Malibu</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 bg-surface/50 p-4 rounded-xl border border-white/5">
                  <Users className="w-5 h-5 text-white/40 shrink-0" />
                  <div>
                    <p className="text-xs text-white/40 uppercase font-bold mb-1">Guest Count</p>
                    <p className="text-sm text-white font-medium">150 Guests</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 bg-surface/50 p-4 rounded-xl border border-white/5">
                  <FileText className="w-5 h-5 text-white/40 shrink-0" />
                  <div>
                    <p className="text-xs text-white/40 uppercase font-bold mb-1">Event Type</p>
                    <p className="text-sm text-white font-medium">Wedding Reception</p>
                  </div>
                </div>
              </div>

              <div className="space-y-2">
                <label className="text-sm font-medium text-white/90">Customer Notes</label>
                <div className="bg-white/5 p-4 rounded-xl border border-white/5 text-sm text-white/80 italic">
        ...
        <div className="space-y-6">
          <Card>
            ...
            <CardContent className="pt-6 space-y-4">
              ...
              <div className="space-y-4">
                ...
                {/* Editable Add-on */}
                <div className="space-y-2">
                  <label className="text-xs font-medium text-white/80">Add Travel Fee / Custom Charge</label>
                  <div className="flex gap-2">
                    <input 
                      type="text" 
                      placeholder="Travel Fee" 
                      defaultValue="Travel Fee (Malibu)"
                      className="w-2/3 bg-surface/50 border border-white/10 rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:border-primary/50"
                    />
                    <div className="relative w-1/3">
                      <DollarSign className="w-3 h-3 absolute left-2 top-1/2 -translate-y-1/2 text-white/40" />
                      <input 
                        type="number" 
                        defaultValue="150"
                        className="w-full bg-surface/50 border border-white/10 rounded-lg pl-6 pr-2 py-2 text-sm text-white focus:outline-none focus:border-primary/50"
                      />
                    </div>
                  </div>
                </div>
          ...
          <Button 
            className="w-full bg-green-500 hover:bg-green-600 text-white border-none h-12" 
