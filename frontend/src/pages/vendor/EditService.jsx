    ...
    <div className="space-y-6 max-w-4xl mx-auto pb-12">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-white/60">Update details for "Premium Wedding Videography".</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 pt-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <select className="w-full bg-surface/50 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-primary/50 transition-colors cursor-pointer" defaultValue="photography">
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="w-full h-48 rounded-xl border border-white/10 overflow-hidden relative group cursor-pointer">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <select className="w-full bg-surface/50 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-primary/50 transition-colors cursor-pointer" defaultValue="fixed">
        ...
        <div className="space-y-6">
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="p-4 rounded-xl border border-green-500/20 bg-green-500/5 text-sm">
                ...
                <p className="text-white/60">This service is currently visible to customers in search results.</p>
              </div>
              <div className="pt-2">
                <p className="text-xs text-white/40 flex justify-between">
                  <span>Created:</span>
                  <span className="text-white/80">Jan 12, 2026</span>
                </p>
                <p className="text-xs text-white/40 flex justify-between mt-1">
                  <span>Last Updated:</span>
                  <span className="text-white/80">Oct 05, 2026</span>
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-red-500/20">
            ...
            <CardContent className="space-y-4">
              <p className="text-sm text-white/60">Permanently delete this service. This action cannot be undone and will remove it from all future search results.</p>
