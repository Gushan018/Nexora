    ...
    <div className="space-y-6 max-w-5xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-white/60">Customize your public marketplace storefront appearance and details.</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-6 items-start">
                <div className="w-32 h-32 rounded-2xl bg-surface border-2 border-dashed border-white/20 flex flex-col items-center justify-center hover:border-primary/50 hover:bg-surface/50 cursor-pointer transition-all group shrink-0">
                  <ImageIcon className="w-8 h-8 text-white/40 group-hover:text-primary mb-2" />
                  <span className="text-xs text-white/60 font-medium">Upload Logo</span>
                </div>
              ...
              <div className="space-y-1.5">
                <label className="text-sm font-medium text-white/90">About Us / Store Description</label>
                <textarea 
                  rows="5" 
        ...
        <div className="lg:col-span-1 space-y-6">
          <Card>
            ...
            <CardContent>
              <div className="w-full h-40 rounded-xl bg-surface border-2 border-dashed border-white/20 flex flex-col items-center justify-center hover:border-primary/50 hover:bg-surface/50 cursor-pointer transition-all group overflow-hidden relative">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <label className="flex items-center justify-between p-4 rounded-xl border border-white/10 bg-surface/30 cursor-pointer">
                <div>
                  <h4 className="text-white font-medium text-sm">Store Visibility</h4>
                  <p className="text-xs text-white/50">Turn on to appear in search</p>
                </div>
              ...
              <label className="flex items-center justify-between p-4 rounded-xl border border-white/10 bg-surface/30 cursor-pointer">
                <div>
                  <h4 className="text-white font-medium text-sm">Accepting New Orders</h4>
                  <p className="text-xs text-white/50">Allow customers to buy</p>
                </div>
                <div className="w-12 h-6 bg-primary rounded-full relative cursor-pointer">
                  <div className="w-5 h-5 bg-white rounded-full absolute right-0.5 top-0.5" />
                </div>
