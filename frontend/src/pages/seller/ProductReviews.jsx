  ...
  return (
    <div className="pt-24 pb-12 container mx-auto px-6 max-w-7xl">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold text-white tracking-tight">Product Reviews</h1>
          <p className="text-white/60 mt-2">Information and details for Product Reviews.</p>
        </div>
        <Card>
          <CardHeader>
